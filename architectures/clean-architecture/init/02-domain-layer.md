...
Copiar desde `templates/manual/paso-03-domain/` a `src/{ProjectName}.domain/`:
...
Copiar desde `templates/manual/paso-05-common-tests/` a `tests/{ProjectName}.domain.tests/`:
- `DomainTestBase.cs`
